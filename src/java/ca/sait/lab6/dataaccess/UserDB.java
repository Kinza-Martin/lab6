...
public class UserDB {
    ...
    public List<User> getAll() throws Exception {
        ...
        String sql = "SELECT * FROM user INNER JOIN role ON role.role_id ";
    ...
    public User get(String email) throws Exception {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String sql = "SELECT * FROM user INNER JOIN role ON role.role_id user.role FROM user WHERE email=?";
